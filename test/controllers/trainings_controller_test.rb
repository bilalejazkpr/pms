...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { date_finish: @training.date_finish, date_start: @training.date_start, description: @training.description, status: @training.status, title: @training.title }
    end
  ...
  test "should update training" do
    patch :update, id: @training, training: { date_finish: @training.date_finish, date_start: @training.date_start, description: @training.description, status: @training.status, title: @training.title }
    assert_redirected_to training_path(assigns(:training))
  end
