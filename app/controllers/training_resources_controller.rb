class TrainingResourcesController < ApplicationController
  ...
  # GET /training_resources
  # GET /training_resources.json
  def index
    @training_resources = TrainingResource.all
  end

  # GET /training_resources/1
  # GET /training_resources/1.json
  def show
  end
  ...
  # PATCH/PUT /training_resources/1
  # PATCH/PUT /training_resources/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /training_resources/1
  # DELETE /training_resources/1.json
  def destroy
  ...
  private
    ...
    def training_resource_params
      params.require(:training_resource).permit(:idtraining, :idresource)
    end
end
